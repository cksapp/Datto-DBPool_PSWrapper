...
```
Get-DBPoolContainer [[-Id] <Int32[]>] [-ListContainer] [-Name <String>] [-DefaultDatabase <String>] [-NotLike]
 [<CommonParameters>]
```
...
### ParentContainer
```
Get-DBPoolContainer [[-Id] <Int32[]>] [-ParentContainer] [-Name <String>] [-DefaultDatabase <String>]
...
This parameter is required when using the ParentContainer or ChildContainer parameter sets.
