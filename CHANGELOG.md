...
- Restructured CI/CD with reusable workflows and improved docs publishing.
- Updated GitHub Actions tooling (Dependabot, CodeQL, MkDocs) and fixed auth/env handling.
- Fixed build ordering, removed pinned PowerShell version, and corrected encoding issues.
